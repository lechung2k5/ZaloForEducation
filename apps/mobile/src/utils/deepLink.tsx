 ...
 */
export const navigateToProfile = ({ userId, onNavigate }: { userId: string; onNavigate: any }) => {
    if (!userId) {
 ...
 */
export const getHighlightColor = (type: string) => {
 ...
 */
export const prepareMessageForDisplay = (message: any, keyword: string) => {
