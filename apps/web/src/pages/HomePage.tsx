...
// import type { Conversation, Message, Friendship, User } from "@zalo-edu/shared";

// type MessageReactions = Record<string, string[]>;
// type ReactionMap = Record<string, MessageReactions>;
// type UserProfile = {
//   email: string;
//   fullName?: string;
//   fullname?: string;
...
// /**
//  * [SENIOR] Safe check for Call History messages
//  */
// const isSystemCallMessage = (message: any) => {
//   return (
...
//   const upsertConversationLastMessage = (convId: string, msg: Message) => {
...
//   const openContextMenuForMessage = (message: Message, x: number, y: number) => {
...
//   const getReactionData = (message: Message) => messageReactions[message.id] || {};

//   const getCurrentUserReaction = (message: Message) => {
...
//   async function handleSelectChat(chat: Conversation) {
...
//       if (!existing) {
//         setConversations((prev: Conversation[]) => [directChat, ...prev]);
//       }
...
//                   if (isSystemCallMessage(message)) {
//                     return (
