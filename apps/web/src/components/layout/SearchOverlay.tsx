           ...
           {!searchQuery ? (
             ...
             <div className="max-w-xl mx-auto space-y-8 py-4">
                ...
                <div className="text-center py-12 space-y-3">
                   ...
                   <p className="text-[16px] font-extrabold text-on-surface mb-1">UniChat Global Search</p>
                   <p className="text-[14px] text-on-surface-variant/60 max-w-[280px] mx-auto leading-relaxed">Tìm kiếm nhanh chóng mọi nội dung trong thế giới UniChat của sếp.</p>
                </div>
             </div>
           ) : (
