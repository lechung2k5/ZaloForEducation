...
const PinnedHeader: React.FC = () => {
  ...
  return (
    <div className="relative z-30">
      {/* Main Banner */}
      <div 
        className={`h-12 px-6 bg-amber-50/90 border-b border-amber-200/50 backdrop-blur-xl flex items-center justify-between gap-4 cursor-pointer transition-all hover:bg-amber-100/80 ${isExpanded ? 'rounded-b-none' : ''}`}
          ...
          <div className="flex-1 min-w-0">
            {pinnedIds.length > 1 ? (
              ...
              <div className="flex flex-col">
                <p className="text-[10px] font-black text-amber-600/70 uppercase tracking-widest leading-none mb-0.5">Tin nhắn đã ghim</p>
      ...
      {isExpanded && pinnedIds.length > 1 && (
        <div className="absolute top-full left-0 right-0 bg-white/95 backdrop-blur-2xl shadow-2xl border-b border-outline-variant/20 animate-in slide-in-from-top-2 duration-200 rounded-b-3xl overflow-hidden">
